...
const oddNumberFinder = function(element) {
    if (element % 2 != 0) {
        odds.push(element)
    }
}

nums.forEach(oddNumberFinder)
...
// if (satisfies modulo 15) {go to fizzbuzz array}
// else (satisfies modulo 5) {go to buzz array} 
// else (satisfies modulo 3) {go to fizz array}
let fizz = []
let buzz = []
let fizzbuzz = []

const fizzBuzzFinder = function(element) {
    if (element % 15 === 0) {
